...
# Technological stack:
1. Python/C++
2. Torch/Tensorflow/JAX
3. Pandas & Numpy / Apache Spark / Dask
4. AWS/GCP/Azure (cloud platforms), docker/kubernetes (k8s)
5. Mlflow/ Weights & Biases (W&B) / Neptune.ai / DVC (Data Version Control)
6. MLOps:
6.1 CI/CD: Github actions, Github ci, Jenkins
6.2 Seldon Core, BentoML, MLflow Serving (for deploying models as REST/gRPC microservices) | FastAPI, Flask - python frameworks to serve models in production
6.3 Workflow orchestration: Apache Airflow, Prefect, Dagster (scheduling and orchestrating complex ML pipelines - data prep, training, evaluation, deployment)
...
[Git repo](https://github.com/farukalamai/advanced-machine-learning-engineer-roadmap-2024)
